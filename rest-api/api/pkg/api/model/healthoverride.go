...
func (r *APIMachineHealthReportEntry) Validate() error {
	...
	for i := range r.Alerts {
		...
		if err := validation.ValidateStruct(&r.Alerts[i],
...
type APIMachineHealthReportListResponse struct {
	MachineID           string                        `json:"machineId"`
	HealthReportEntries []APIMachineHealthReportEntry `json:"healthReportEntries"`
}

func NewAPIMachineHealthReportListResponse(machineID string, resp *cwssaws.ListHealthReportResponse) *APIMachineHealthReportListResponse {
	...
	return &APIMachineHealthReportListResponse{
		MachineID:           machineID,
		HealthReportEntries: entries,
	}
}

type APIMachineHealthReportResponse struct {
	MachineID         string                      `json:"machineId"`
	HealthReportEntry APIMachineHealthReportEntry `json:"healthReportEntry"`
}

func NewAPIMachineHealthReportResponse(machineID string, req *APIMachineHealthReportEntry) *APIMachineHealthReportResponse {
	return &APIMachineHealthReportResponse{
		MachineID:         machineID,
		HealthReportEntry: *req,
	}
}

type APIMachineHealthReportRemoveResponse struct {
	MachineID string `json:"machineId"`
	Source    string `json:"source"`
}

func NewAPIMachineHealthReportRemoveResponse(machineID, source string) *APIMachineHealthReportRemoveResponse {
	return &APIMachineHealthReportRemoveResponse{
		MachineID: machineID,
		Source:    source,
	}
}
